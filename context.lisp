...
(defmethod reinitialize-instance :after ((context context))
  (when (context-needs-recreation context)
    (with-context (context)
      (destroy-context context)
      (create-context context))))

(defmacro define-context-accessor (name q+)
  `(progn (defmethod ,name ((context context))
            (q+ ,q+ (glformat context)))
          (defmethod (setf ,name) (value (context context))
            (setf (q+ ,q+ (glformat context)) value)
...
(define-context-accessor overlay overlay)
