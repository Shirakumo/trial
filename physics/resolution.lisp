...
(defmethod resolve-collision ((a rigidbody) (b rigidbody) contact)
  ...
  (flet ((angular-inertia (entity loc inverse-mass)
           (if (= 0 inverse-mass)
               0f0
               (let ((cross (vec3)))
    ...
    (let* ((a (contact-a contact))
           (b (contact-b contact))
           (a-angular-inertia (angular-inertia a (contact-a-relative contact) (contact-a-inverse-mass contact)))
           (b-angular-inertia (angular-inertia b (contact-b-relative contact) (contact-b-inverse-mass contact)))
