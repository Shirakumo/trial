...
(asdf:defsystem trial
  ...
  :components ((:file "package")
               ...
               (:file "prompt-tables" :depends-on ("package" "prompt"))
               ...
               (:module "renderer"
                ...
                :components ((:file "cpu-particle" :depends-on ("particle-common"))
                             ...
                             (:file "particle-common" :depends-on ("standard-renderer" "particle-force-fields"))
                             (:file "particle-force-fields" :depends-on ())
