...
(asdf:defsystem trial
  ...
  :components ((:file "package")
               ...
               (:file "helpers" :depends-on ("package" "container" "transforms" "shader-entity" "asset" "asset-pool" "resources" "loader" "geometry" "geometry-shapes" "incremental-loader"))
               (:file "incremental-loader" :depends-on ("package" "loader"))
               ...
               (:file "shader-pass" :depends-on ("package" "shader-entity" "helpers" "resource" ("resources" "framebuffer") ("resources" "shader-program") "scene" "loader" "context" "geometry-shapes" "camera" "incremental-loader"))
