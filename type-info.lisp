...
(defun gl-memref-std140 (ptr type &optional container)
  (flet ((%ref (i)  (cffi:mem-aref ptr :float i))
         ...
         (%uref (i) (cffi:mem-aref ptr :uint32 i)))
    (declare (inline %ref %iref %uref))
    (ecase type
      ...
      (:ivec2 (unless container (setf container (vec2)))
       (vsetf container (%iref 0) (%iref 1)))
      (:ivec3 (unless container (setf container (vec3)))
       (vsetf container (%iref 0) (%iref 1) (%iref 2)))
      (:ivec4 (unless container (setf container (vec4)))
       (vsetf container (%iref 0) (%iref 1) (%iref 2) (%iref 3)))
      (:uvec2 (unless container (setf container (vec2)))
       (vsetf container (%iref 0) (%uref 1)))
      (:uvec3 (unless container (setf container (vec3)))
       (vsetf container (%uref 0) (%uref 1) (%uref 2)))
      (:uvec4 (unless container (setf container (vec4)))
       (vsetf container (%uref 0) (%uref 1) (%uref 2) (%uref 3)))
