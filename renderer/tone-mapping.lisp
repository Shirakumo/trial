...
(define-shader-pass hable (tone-mapping-pass)
  ((shoulder-strength :initarg :shoulder-strength :initform 0.0 :accessor shoulder-strength :uniform "a")
   (linear-strength :initarg :linear-strength :initform 0.0 :accessor linear-strength :uniform "b")
   (linear-angle :initarg :linear-angle :initform 0.0 :accessor linear-angle :uniform "c")
   (toe-strength :initarg :toe-strength :initform 0.0 :accessor toe-strength :uniform "d")
   (toe-numerator :initarg :toe-numerator :initform 0.0 :accessor toe-numerator :uniform "e")
   (toe-denominator :initarg :toe-denominator :initform 0.0 :accessor toe-denominator :uniform "f")
   (linear-white-point :initarg :linear-white-point :initform 0.0 :accessor linear-white-point :uniform "w")
...
(define-shader-pass reinhard-extended (tone-mapping-pass) 
  ((c-white :initarg :c-white :initform 0.0 :accessor c-white :uniform "c_white"))
  (:shader-file (trial "tone-map/reinhard-extended.glsl")))

(define-shader-pass schlick (tone-mapping-pass) 
  ((p :initarg :p :initform 0.0 :accessor p :uniform "p")
   (hi-val :initarg :hi-val :initform 0.0 :accessor hi-val :uniform "hi_val"))
...
(define-shader-pass tumblin-rushmeier (tone-mapping-pass)
  ((luminance-map :port-type input :texspec (:internal-format :r16))
   (ld-max :initarg :ld-max :initform 0.0 :accessor ld-max :uniform "ld_max")
   (c-max :initarg :c-max :initform 0.0 :accessor c-max :uniform "c_max"))
  (:shader-file (trial "tone-map/tumblin-rushmeier.glsl")))

(define-shader-pass uchimura (tone-mapping-pass)
  ((max-brightness :initarg :max-brightness :initform 0.0 :accessor max-brightness :uniform "m")
   ...
   (linear-length :initarg :linear-length :initform 0.0 :accessor linear-length :uniform "l")
   (black-tightness-shape :initarg :black-tightness-shape :initform 0.0 :accessor black-tightness-shape :uniform "c")
